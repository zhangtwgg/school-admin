...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/ace.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/ace-part2.css" />
		<![endif]-->
						...
						<div class="login-container">
							<div class="center" style="margin-top: 120px;">
								<h1>
									...
									<span class="red">教师</span>
									<span class="white" id="id-text2">管理平台</span>
								</h1>
								<h4 class="blue" id="id-company-text">用户登录</h4>
							</div>
