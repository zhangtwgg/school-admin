        ...
        <div class="col-xs-12">
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input class="form-control date-picker" style="cursor: pointer" data-date-format="yyyy-mm-dd" readonly="" id="birthday" type="text" placeholder="请选择出生日期"/>

                    </div>
                    <label class="col-sm-1 control-label" for="workDay">入职日期</label>
                    <div class="col-sm-4">
                        <input class="form-control date-picker " style="cursor: pointer" data-date-format="yyyy-mm-dd"  readonly="" id="workDay" type="text" placeholder="请选择入职日期"/>
                    </div>
                </div>
                <div class="form-group">
